...
# startupdelay_horizon documentation build
...
from startupdelay_horizon import __version__ as release

# -- Project information -----------------------------------------------------

project = "startupdelay_horizon"
author = "Kedro"
...
htmlhelp_basename = "startupdelay_horizondoc"
...
latex_documents = [
    (
        master_doc,
        "startupdelay_horizon.tex",
        "startupdelay_horizon Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "startupdelay_horizon",
        "Project startupdelay_horizon codebase.",
        "Data-Science",
    )
]
